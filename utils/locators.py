...
class MainPageLocators:
    ...
    PRIVATE_AREA = (By.XPATH, "//a[@href='/account']")  # Главная страница, кнопка перехода в Личный кабинет
    ORDER_BUTTON = (By.XPATH, "//button[text()='Оформить заказ']")  # Кнопка на главной странице, доступная
    ...
    BASKET = (By.XPATH, "//section[contains(@class, 'BurgerConstructor_basket')]")  # Локатор для корзины
    TEMPORARY_ORDER_MODAL_HEADER = (By.XPATH, "//h2[text()='9999']")
    ORDER_ID_XPATH = "//h2[contains(@class, 'Modal_modal__title')]"


class LoginPageLocators:
    LOGIN_HEADER = (By.XPATH, "//h2[text()='Вход']")  # Заголовок формы логина
    BUTTON_RESTORE_PASSWORD = (By.XPATH, "//a[text()='Восстановить пароль']")  # Гиперссылка для восстановления пароля
    EMAIL_INPUT_FIELD = (
        By.XPATH, "//label[text()='Email']/following-sibling::input[@name='name']")  # Поле ввода e-mail
    PASSWORD_INPUT_FIELD = (By.XPATH, ".//input[@type='password']")  # Поле ввода пароля
    BUTTON_LOGIN = (By.XPATH, "//button[text()='Войти']")  # Кнопка входа на форме логина


class PrivateArea_Locators:
...
class ResetPasswordPageLocators:
    HEADER_RESET_PASSWORD = (By.XPATH, ".//h2[text()='Восстановление пароля']")  # Хедер страницы восстан. пароля
    # с кодом из письма
    VIEW_PASSWORD_BUTTON = (By.XPATH, ".//div[contains(@class, 'input__icon')]")
    ACTIVE_INPUT_FIELD = (By.XPATH, ".//div[contains(@class, 'input_status_active')]")


class FeedPageLocators:
    FEED_HEADER = (By.XPATH, ".//h1[text()='Лента заказов']")  # Хедер страницы ленты заказов
...
class HistoryOfOrdersPageLocators:
